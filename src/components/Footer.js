          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p>
                  <i className="bi bi-geo-alt-fill pe-3"></i> Coimbatore, Tamil
                  Nadu
                </p>
                <p>
                  <i className="bi bi-envelope-fill pe-3"></i> info@gmail.com
                </p>
                <p>
                  <i className="bi bi-phone-fill pe-3"></i> 97 905 609 38
                </p>
                <p>
                  <i className="bi bi-telephone-fill pe-3"></i> 94 866 288 84
                </p>
              </div>
            </div>
          </div>
