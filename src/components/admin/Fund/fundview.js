...
export default function ViewSelectedFund() {
  const [fund, setFund] = useState({
    organizationID: "",
    endingDate: "2023-09-27T12:20:02.029+00:00",
  });
  ...
  useEffect(() => {
    getOrganizationByID(fund.organizationID).then((res) => {
    ...
    <>
      <main className="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div className="container-fluid" onClick={toggleSidenav}>
          <i
            className="bi bi-arrow-left-circle fs-4 cursor-pointer"
            onClick={() => navigate(-1)}
          >
            {" "}
            Go back
          ...
          {fund.organizationID === getCookie("uId") &&
              ...
              <div className="col-sm-5 row">
                ...
                <div className="card p-3">
                  ...
                  <div className="row mt-2">
                    <h6 className="text-dark font-weight-bold col-md-3">
                      Email:
                    </h6>
              ...
              <div className="col-sm-7 my-5 ps-sm-4">
                ...
                <div className="mt-3">
                  <div className="d-flex">
                    <div className="text-dark font-weight-bold p-2 ps-0">
                      Budget:
                    </div>
                  ...
                  <div>
                    <ProgressBar
                      completed={
                        Math.round(
                          (fund.currentAmount / fund.budget) * 100 * 100
                        ) / 100
                  ...
                  <div className="d-flex">
                    ...
                    <div className="p-2">
                      {getRemainingTime(fund.endingDate)}
                    </div>
                  </div>
                  <div className="mt-3">
                    <h5 className="text-dark font-weight-bold p-2 ps-0">
                      Description
                    </h5>
